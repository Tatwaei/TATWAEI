...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: coordinatorOppo(),
    );
  }
}

class coordinatorOppo extends StatefulWidget {
  @override
  _OpportunityPageState createState() => _OpportunityPageState();
}

class _OpportunityPageState extends State<coordinatorOppo> {
  late List<DocumentSnapshot> internalOpportunities = [];

  @override
  void initState() {
    super.initState();
    fetchInternalOpportunities();
  }
  ...
  Future<void> fetchInternalOpportunities() async {
    ...
    QuerySnapshot snapshot = await internalOpportunity
        ...
        .get();
    setState(() {
      internalOpportunities = snapshot.docs;
    });
  }
          ...
          children: [
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => coorAdd()),
                    );
                  },
                  child: Container(
            ...
            Expanded(
              child: ListView.builder(
                itemCount: internalOpportunities.length,
                itemBuilder: (context, index) {
                  DocumentSnapshot opportunity = internalOpportunities[index];
