                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                           ...
                           _buildEditableDropdown('المجال التطوعي', interest, ['ادارية', 'خدمية', 'صحية', 'اجتماعية', 'اخرى'], (String? newValue) {
  if (newValue != null) {
    setState(() {
      interest = newValue;
    });
...
_buildEditableDropdown('الجنس', gender, ['ذكر', 'أنثى', 'كلاهما'], (String? newValue) {
  if (newValue != null) {
    setState(() {
      gender = newValue;
    });
  ...
  // Function to build an editable date picker widget
  ...
  // Function to build an editable dropdown list widget
  Widget _buildEditableDropdown(String label, String value, List<String> items, Function(String?) onChanged) {
    return Padding(
      padding: EdgeInsets.only(right: 5, left: 5, top: 3),
      child: Container(
        margin: EdgeInsets.only(right: 10),
...
class _OpportunityPageState extends State<aEdit> {
  ...
  final List<String> genders = ['ذكر', 'أنثى', 'كلاهما'];
  final List<String> interests = ['ادارية', 'خدمية', 'صحية', 'اجتماعية', 'اخرى'];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildDropDownList('المجال التطوعي', interest, interests, (value) {
                              setState(() {
                                interest = value;
                              });
                            }),
                            _buildDropDownList('الجنس', gender, genders, (value) {
                              setState(() {
                                gender = value;
                              });
                            }),
  ...
  // Function to build a dropdown list widget
  Widget _buildDropDownList(String label, String value, List<String> options, Function(String) onChanged) {
    return Padding(
      padding: EdgeInsets.only(right: 5, left: 5, top: 3),
      child: Container(
        margin: EdgeInsets.only(right: 10),
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: 20),
            DropdownButton<String>(
              value: value, // Set the value to the selected item
              onChanged: (newValue) {
                onChanged(newValue!);
              },
              items: options.map<DropdownMenuItem<String>>((String option) {
                return DropdownMenuItem<String>(
                  value: option, // Set unique value for each item
                  child: Text(option),
                );
              }).toList(),
            ),
