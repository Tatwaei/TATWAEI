...
class coorEdit extends StatefulWidget {
  @override
  _coorEditState createState() => _coorEditState();
}

class _coorEditState extends State< coorEdit> {
  @override
  ...
  child: Container(
    ...
    child: Row(
      ...
      children: [
        ...
        SizedBox(width: 5), // Add some space between the icon and text
        Text(
             "الفوائد المكتسبه من الفرصة التطوعيه",
          style: TextStyle(
            fontWeight: FontWeight.bold,
            color: Color.fromARGB(255, 127, 179, 71),
            fontSize: 16,
