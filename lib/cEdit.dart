...
class _OpportunityPageState extends State<cEdit> {
  ...
  final List<String> genders = ['ذكر', 'انثى', 'كلاهما'];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildDropDown('المجال التطوعي', interest, interests, (value) {
                              setState(() {
                                interest = value;
                              });
                            }),
                            _buildDropDown('الجنس', gender, genders, (value) {
                              setState(() {
                                gender = value;
                              });
                            }),
...
floatingActionButtonLocation: FloatingActionButtonLocation.centerFloat,
  ...
  // Function to build a dropdown widget
  ...
  // Function to build a date picker widget
  Widget _buildEditableDate(String label, DateTime date, Function(DateTime) onChanged) {
    return Padding(
      padding: EdgeInsets.only(right: 5, left: 5, top: 3),
      child: Container(
