...
class coorEditDelete extends StatefulWidget {
  @override
  _coorEditDeleteState createState() => _coorEditDeleteState();
}

class _coorEditDeleteState extends State<coorEditDelete> {
  @override
